        ...
        for mechanism in mechanisms:
            for rate in rates:
                ...
                for m, x_completed in enumerate(method_result["completed_datasets"], start=1):
                    ...
                    imputation_metric_rows.append({**context, **metrics})
                ...
                print(
                    ...
                    f"ARI={pooled['ari_vs_full_data_kmeans']:.3f} "
                    f"Rubin SE={pooled['ari_vs_full_data_kmeans_rubin_se']:.3f}"
                )
