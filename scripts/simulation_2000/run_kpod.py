...
def run_kpod(x_missing, random_state):
    ...
    return {
        ...
        "precomputed": [(final_model, final_labels)],
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run the complete K-POD simulation script.")
