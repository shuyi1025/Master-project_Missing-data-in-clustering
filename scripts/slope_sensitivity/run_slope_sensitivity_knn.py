"""Run slope sensitivity for KNN imputation across synthetic dataset sizes."""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run slope sensitivity for KNN imputation."
    )
    parser.add_argument(
        "--synthetic-size",
    ...
    parser.add_argument(
        "--output-prefix",
        default="sensitivity_knn_slope4",
