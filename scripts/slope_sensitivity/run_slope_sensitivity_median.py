"""Run slope sensitivity for median imputation across synthetic dataset sizes."""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run slope sensitivity for median imputation."
    )
    parser.add_argument(
        "--synthetic-size",
    ...
    parser.add_argument(
        "--output-prefix",
        default="sensitivity_median_slope4",
