"""Plot mean silhouette score across missingness rates for every 5000-sample method."""
...
SIMULATION_DIR = PROJECT_ROOT / "outputs" / "simulation5000"
...
def main() -> None:
    ...
    for mechanism in ["MAR", "MCAR", "MNAR"]:
        ...
        ax.set_title(
            f"Mean Silhouette Score by Missingness Rate ({mechanism})",
            fontweight="bold",
        )
        ...
        output_path = SIMULATION_DIR / (
            f"mean_silhouette_all_methods_{mechanism.lower()}.png"
        )
